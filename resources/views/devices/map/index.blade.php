            ...
            if (device.latitude && device.longitude) {
                ...
                var htmlContent = `
                    <div style="display:flex; align-items:flex-start; gap: 10px; text-align: left;">
                        ${imgHtml}
                        <div style="flex:1;">
                            <h4 style="margin:0; font-size:14px; font-weight:bold; color: #0f172a;" class="dark:text-white">${device.nama}</h4>
                            <div style="font-size:12px; color: #64748b; margin-top:4px;" class="dark:text-slate-300">
